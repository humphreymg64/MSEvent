...
{
    public class EventToCommandBehavior : BindableBehaviour<View>
    {
        ...
        private void OnFired(object sender, EventArgs eventArgs)
        {
            ...
            if (eventArgs != null && eventArgs != EventArgs.Empty)
            {
                ...
                {
                    parameter = EventArgsConverter.Convert(eventArgs, typeof(object), EventArgsConverterParameter, System.Globalization.CultureInfo.CurrentUICulture);
                }
            }
