namespace ReadDeviceToCloudMessages
{
    ...
    {
        private const string ConnectionString = "HostName=AppInnovationHub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=dtXOR0tsnVpAdsHI00PJwjWK9rk8883ANEJb8eoDFxw=";
